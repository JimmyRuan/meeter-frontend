...
import {fetchCount, fetchMeetings} from './meetingAPI';
...
export const findMeetingsAsync = createAsyncThunk(
  ...
  async () => {
    ...
    console.log('I am here at 19', response)
...
export const meetingSlice = createSlice({
  ...
  // including actions generated by createAsyncThunk or in other slices.
    ...
    //     [findMeetingsAsync.fulfilled]: (state, action) => {
    //         // Add user to the state array
    //         console.log('I am here at 54 now');
  ...
  extraReducers: (builder) => {
    builder
      .addCase(findMeetingsAsync.pending, (state) => {
          console.log('I am at 51 for extraReducer');
